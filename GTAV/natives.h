...
namespace PLAYER
{
	...
	static int GET_PLAYER_INDEX() { return invoke<int>(0x309BBDC1); } // 0x309BBDC1
...
namespace ENTITY
{
	...
	static Vector3 GET_ENTITY_COORDS(Entity entity, BOOL unkBool = false) { return invoke<Vector3>(0x1647F1CB, entity, unkBool); } // 0x1647F1CB
	...
	static void ATTACH_ENTITY_TO_ENTITY(Entity entity1, Entity entity2, int boneIndex, float x, float y, float z, float rot_x, float rot_y, float rot_z, BOOL p9, BOOL useSoftPinning, BOOL collision, BOOL isPed, int vertexIndex, BOOL fixedRot) { invoke<Void>(0xEC024237, entity1, entity2, boneIndex, x, y, z, rot_x, rot_y, rot_z, p9, useSoftPinning, collision, isPed, vertexIndex, fixedRot); } // 0xEC024237
...
namespace PED
{
	...
	static void FORCE_ALL_HEADING_VALUES_TO_ALIGN(Ped ped) { invoke<Void>(0x290421BE, ped); } // 0x290421BE
	...
	static void SET_USE_CAMERA_HEADING_FOR_DESIRED_DIRECTION_LOCK_ON_TEST(Ped ped,BOOL toggle) {invoke<Void>(0x7F67671D, ped, toggle);} // 0x7F67671D
	...
	static void SET_PED_MOVEMENT_CLIPSET(Any p0, Any p1, Any p2) { invoke<Void>(0xA817CDEB, p0, p1, p2); } // 0xA817CDEB
	...
	static void REGISTER_TARGET(Ped p0, Ped p1) { invoke<Void>(0x50A95442, p0, p1); } // 0x50A95442
...
namespace VEHICLE
{
	...
	static void GET_VEHICLE_EXTRA_COLOURS(Any p0, Any p1, Any p2) { invoke<Void>(0x80E4659B, p0, p1, p2); } // 0x80E4659B
	...
	static void SET_VEHICLE_DAMAGE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x21B458B2, p0, p1, p2, p3, p4, p5, p6); } // 0x21B458B2
...
namespace OBJECT
{
	...
	static Any SLIDE_OBJECT(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { return invoke<Any>(0x63BFA7A0, p0, p1, p2, p3, p4, p5, p6, p7); } // 0x63BFA7A0
	...
	static Any CREATE_PORTABLE_PICKUP(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<Any>(0x8C886BE5, p0, p1, p2, p3, p4, p5); } // 0x8C886BE5
	...
	static void CREATE_MONEY_PICKUPS(float XCoord, float YCoord, float ZCoord, int Value, int amount, Hash model) { invoke<Void>(0x36C9A5EA, XCoord, YCoord, ZCoord, Value, amount, model); } // 0x36C9A5EA
...
namespace GAMEPLAY
{
	...
	static Any GET_DISTANCE_BETWEEN_COORDS(float x1, float y1, float z1, float x2, float y2, float z2, BOOL useZ) { return invoke<Any>(0xF698765E, x1, y1, z1, x2, y2, z2, useZ); } // 0xF698765E
	...
	static BOOL COMPARE_STRINGS(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0xFE25A58F, p0, p1, p2, p3); } // 0xFE25A58F
	...
	static void ENABLE_TENNIS_MODE(Ped ped, BOOL toggle, BOOL p2) {invoke<Void>(0x0BD3F9EC, ped, toggle, p2);} // 0x0BD3F9EC
	...
	static void SET_RIOT_MODE_ENABLED(bool p0) { invoke<Void>(0xD9660339, p0); } // 0xD9660339
...
namespace INTERIOR
{
	...
	static Any GET_INTERIOR_AT_COORDS(Any p0, Any p1, Any p2) { return invoke<Any>(0xA17FBF37, p0, p1, p2); } // 0xA17FBF37
...
namespace WEAPON
{
	...
	static bool GET_PED_LAST_WEAPON_IMPACT_COORD(Ped Handle, Vector3 *Coords) { return invoke<BOOL>(0x9B266079, Handle, Coords); } // 0x9B266079
...
namespace STREAMING
{
	...
	static void LOAD_SCENE(Any p0, Any p1, Any p2) { invoke<Void>(0xB72403F5, p0, p1, p2); } // 0xB72403F5
	...
	static BOOL IS_MODEL_VALID(int hash) { return invoke<BOOL>(0xAF8F8E9D, hash); } // 0xAF8F8E9D
	...
	static void _0x14680A60(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x14680A60, p0, p1, p2, p3, p4, p5); } // 0x14680A60
...
namespace UI
{
	static void BEGIN_TEXT_COMMAND_BUSYSPINNER_ON(char* p0) { invoke<Void>(0xCB7C8994, p0); } // 0xCB7C8994
	static void _0x903F5EE4(int p0) { invoke<Void>(0x903F5EE4, p0); } // 0x903F5EE4
	static void BUSYSPINNER_OFF() { invoke<Void>(0x94119534); } // 0x94119534
	...
	static void _0x51E7A037(Any p0) { invoke<Void>(0x51E7A037, p0); } // 0x51E7A037
	static Any _0xD12A643A(Any p0) { return invoke<Any>(0xD12A643A, p0); } // 0xD12A643A
	static void _0x94B82066(Any p0) { invoke<Void>(0x94B82066, p0); } // 0x94B82066
	static Any _0xAA318785(Any p0, Any p1) { return invoke<Any>(0xAA318785, p0, p1); } // 0xAA318785
	static void _0xB245FC10(Any p0) { invoke<Void>(0xB245FC10, p0); } // 0xB245FC10
	...
	static void ADD_TEXT_COMPONENT_FLOAT(char* text, float DecimalPlaces) { invoke<Void>(0x24D78013, text, DecimalPlaces); } // 0x24D78013
	static void _0xDCE05406(Any p0) { invoke<Void>(0xDCE05406, p0); } // 0xDCE05406
	...
	static Any _0x34A396EE(Any p0, Any p1, Any p2) { return invoke<Any>(0x34A396EE, p0, p1, p2); } // 0x34A396EE
	...
	static Any _0x95C4B5AD(Any p0) { return invoke<Any>(0x95C4B5AD, p0); } // 0x95C4B5AD
	...
	static void REPLACE_HUD_COLOUR_WITH_RGBA(int hudColorIndex, RGBA rgba) { invoke<Void>(0xF6E7E92B, hudColorIndex, rgba); } // 0xF6E7E92B
	...
	static Any _0x3330175B(Any p0, Any p1) { return invoke<Any>(0x3330175B, p0, p1); } // 0x3330175B
	...
	static void SET_TEXT_RIGHT_JUSTIFY(Any p0) { invoke<Void>(0x45B60520, p0); } // 0x45B60520
	...
	static void SET_BIGMAP_ACTIVE(BOOL toggleBigMap, BOOL showFullMap) { invoke<Void>(0x08EB83D2, toggleBigMap, showFullMap); } // 0x08EB83D2
	...
	static void SET_WARNING_MESSAGE_WITH_HEADER_AND_SUBSTRING_FLAGS(char* entryHeader, char* entryLine1, int instructionalKey, char* entryLine2, BOOL p4, Any p5, Any additionalIntInfo, char* additionalTextInfoLine1, char* additionalTextInfoLine2, BOOL showBackground, int errorCode) { invoke<Void>(0x749929D3, entryHeader, entryLine1, instructionalKey, entryLine2, p4, p5, additionalIntInfo, additionalTextInfoLine1, additionalTextInfoLine2, showBackground, errorCode); } // 0x749929D3
	static BOOL IS_WARNING_MESSAGE_ACTIVE() { return invoke<BOOL>(0x94C834AD); } // 0x94C834AD
...
namespace GRAPHICS
{
	...
	static void DRAW_RECT(float posX, float posY, float scaleX, float scaleY, int R, int G, int B, int A) { invoke<Void>(0xDD2BFC77, posX, posY, scaleX, scaleY, R, G, B, A); } // 0xDD2BFC77
	...
	static void SET_DRAW_ORIGIN(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xE10198D5, p0, p1, p2, p3); } // 0xE10198D5
	...
	static Any _0x1F950E4B(Any p0, Any p1, Any p2, Any p3, Any p4) { return invoke<Any>(0x1F950E4B, p0, p1, p2, p3, p4); } // 0x1F950E4B
	...
	static Any START_PARTICLE_FX_LOOPED_AT_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11) { return invoke<Any>(0xD348E3E6, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); } // 0xD348E3E6
	...
	static void ENABLE_CLOWN_BLOOD_VFX(BOOL toggle) { invoke<Void>(0xC61C75E9, toggle); } // 0xC61C75E9
	...
	static void _0x9C720B61(Any p0) { invoke<Void>(0x9C720B61, p0); } // 0x9C720B61
	...
	static void SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(Any p0) { invoke<Void>(0x5FED3BA1, p0); } // 0x5FED3BA1
	static void _0x18C9DE8D(Any p0, Any p1) { invoke<Void>(0x18C9DE8D, p0, p1); } // 0x18C9DE8D
	static void DRAW_SCALEFORM_MOVIE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0x48DA6A58, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0x48DA6A58
	...
	static Any _0x215ABBE8(Any p0, char* p1) { return invoke<Any>(0x215ABBE8, p0, p1); } // 0x215ABBE8
	...
	static void _0x02DBF2D7() { invoke<Void>(0x02DBF2D7); } // 0x02DBF2D7
	...
	static void _0x716777CB(Any p0) { invoke<Void>(0x716777CB, p0); } // 0x716777CB
	static void _0x9A01FFDA(Any p0) { invoke<Void>(0x9A01FFDA, p0); } // 0x9A01FFDA
	static void _0x0D4AE8CB(Any p0) { invoke<Void>(0x0D4AE8CB, p0); } // 0x0D4AE8CB
	static void _0x3AC9CB55(char* p0) { invoke<Void>(0x3AC9CB55, p0); } // 0x3AC9CB55
	static void _0x386CE0B8() { invoke<Void>(0x386CE0B8); } // 0x386CE0B8
	static void _0x2E80DB52() { invoke<Void>(0x2E80DB52); } // 0x2E80DB52
	static void _0x4DAAD55B(Any p0) { invoke<Void>(0x4DAAD55B, p0); } // 0x4DAAD55B
	...
	static void _0x06BB5CDA(Any p0) { invoke<Void>(0x06BB5CDA, p0); } // 0x06BB5CDA
...
namespace STATS
{
	...
	static Any STAT_SET_INT1(Hash statName, int value) { return invoke<Any>(0xC9CC1C5C, statName, value); } // 0xC9CC1C5C
	...
	static bool STAT_SET_DATE(Hash statName, Posix* Value, int numFields, bool save) { return invoke<BOOL>(0x36BE807B, statName, Value, numFields, save); } // 0x36BE807B
	...
	static void PLAYSTATS_ODDJOB_DONE(Any p0, Any p1, Any p2) { invoke<Void>(0xFE14A8EA, p0, p1, p2); } // 0xFE14A8EASF
	...
	static void PLAYSTATS_IDLE_KICK(Any p0) { invoke<Void>(0x9E2B9522, p0); } // 0x9E2B9522
...
namespace MOBILE
{
	...
	static void SET_MOBILE_PHONE_POSITION(Any p0, Any p1, Any p2) { invoke<Void>(0x841800B3, p0, p1, p2); } // 0x841800B3
...
namespace TIME
{
	...
	static void ADD_TO_CLOCK_TIME(int hour, int minute, int second) { invoke<Void>(0xCC40D20D, hour, minute, second); } // 0xCC40D20D
...
namespace DATAFILE
{
	...
	static bool DATAFILE_LOAD_OFFLINE_UGC(const char* file) { return invoke<bool>(0x660C468E, file); } // 0x660C468E
...
namespace WORLDPROBE
{
	...
	static Any _0x8251485D(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { return invoke<Any>(0x8251485D, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0x8251485D
	...
	static Any _0x591EA833(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { return invoke<Any>(0x591EA833, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); } // 0x591EA833
	...
	static Any _0xF3C2875A(Any p0, Any p1, Any p2, Any p3, Any p4) { return invoke<Any>(0xF3C2875A, p0, p1, p2, p3, p4); } // 0xF3C2875A
...
namespace NETWORK
{
	static BOOL NETWORK_ACCESS_TUNABLE_FLOAT_HASH(Hash tunableContext, Hash tunableName, float* value) { return invoke<BOOL>(0x3972551F); }
	...
	static Any NETWORK_HAS_VALID_ROS_CREDENTIALS() { return invoke<Any>(0x3FB40673); } // 0x3FB40673
	static Any NETWORK_IS_CLOUD_AVAILABLE() { return invoke<Any>(0xC7FF5AFC); } // 0xC7FF5AFC
	static Any NETWORK_HAS_SOCIAL_CLUB_ACCOUNT() { return invoke<Any>(0x66EC713F); } // 0x66EC713F
	static Any NETWORK_ARE_SOCIAL_CLUB_POLICIES_CURRENT() { return invoke<Any>(0x358D1D77); } // 0x358D1D77
	...
	static Any NETWORK_SEND_TRANSITION_GAMER_INSTRUCTION(Any p0, Any p1, Any p2, Any p3, Any p4) { return invoke<Any>(0x468B0884, p0, p1, p2, p3, p4); } // 0x468B0884
	...
	static Any NETWORK_GET_HOST_OF_SCRIPT(char *scriptName, Any p1, Any p2) { return invoke<Any>(0x9C95D0BB, scriptName, p1, p2); } // 0x9C95D0BB
	...
	static void NETWORK_HANDLE_FROM_USER_ID(Any p0, Any p1, Any p2) { invoke<Void>(0x74C2C1B7, p0, p1, p2); } // 0x74C2C1B7
	static void NETWORK_HANDLE_FROM_MEMBER_ID(Any p0, Any p1, Any p2) { invoke<Void>(0x9BFC9FE2, p0, p1, p2); } // 0x9BFC9FE2
	static void NETWORK_HANDLE_FROM_PLAYER(Ped PedHandle, int FreeMemPointer, int p2) { invoke<Void>(0xD3498917, PedHandle, FreeMemPointer, p2); } // 0xD3498917
	...
	static Any NETWORK_GET_GAMERTAG_FROM_HANDLE(Any p0) { return invoke<Any>(0xA18A1B26, p0); } // 0xA18A1B26
	...
	static int NETWORK_GET_FRIEND_COUNT() { return invoke<int>(0xA396ACDE); } // 0xA396ACDE
	static char* NETWORK_GET_FRIEND_NAME(int p0) { return invoke<char*>(0x97420B6D, p0); } // 0x97420B6D
	static bool NETWORK_IS_FRIEND_ONLINE(char* p0) { return invoke<bool>(0xE0A42430, p0); } // 0xE0A42430
	static Any NETWORK_IS_FRIEND_IN_SAME_TITLE(char* p0) { return invoke<Any>(0xC54365C2, p0); } // 0xC54365C2
	static BOOL NETWORK_IS_FRIEND_IN_MULTIPLAYER(char* psn) { return invoke<BOOL>(0x400BDDD9, psn); } // 0x400BDDD9
	...
	static Any NETWORK_CREATE_SYNCHRONISED_SCENE(float x, float y, float z, float xRot, float yRot, float zRot, int rotationOrder, BOOL holdLastFrame, BOOL looped, float p9, float animTime, float animSpeed) { return invoke<Any>(0xB06FE3FE, x, y, z, xRot, yRot, zRot, rotationOrder, holdLastFrame, looped, p9, animTime, animSpeed); } // 0xB06FE3FE
	static void NETWORK_ADD_ENTITY_TO_SYNCHRONISED_SCENE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x10DD636C, p0, p1, p2, p3, p4, p5, p6); } // 0x10DD636C
	...
	static int NETWORK_CREATE_SYNCHRONISED_SCENE_1(float x, float y, float z, float xrot, float yrot, float zrot, int p6, int p7, int p8, float p9, float p10, float p11) { return invoke<int>(0xB06FE3FE, x, y, z, xrot, yrot, zrot, p6, p7, p8, p9, p10, p11); } 
	...
	static Any NETWORK_IS_TUTORIAL_SESSION_CHANGE_PENDING() { return invoke<Any>(0xA003C40B); } // 0xA003C40B
	...
	static Any CLOUD_DID_REQUEST_SUCCEED(Any p0) { return invoke<Any>(0x9B9AFFF1, p0); } // 0x9B9AFFF1
	static void _0xC38E9DB0() { invoke<Void>(0xC38E9DB0); } // 0xC38E9DB0
	static Any _0x32A4EB22() { return invoke<Any>(0x32A4EB22); } // 0x32A4EB22
	static Any CLOUD_GET_AVAILABILITY_CHECK_RESULT() { return invoke<Any>(0x9262744C); } // 0x9262744C
	...
	static Any NETWORK_HAVE_ROS_SOCIAL_CLUB_PRIV() { return invoke<Any>(0x424C6E27); } // 0x424C6E27
	...
	static Any NETWORK_HAVE_ROS_LEADERBOARD_WRITE_PRIV() { return invoke<Any>(0xC6EA802E); } // 0xC6EA802E
	...
	static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Ped player, int scene, char* anim, char* animid, float speed, float speedmul, int duration, int flag, float playbackr, Any p9) { invoke<Void>(0xB386713E, player, scene, anim, animid, speed, speedmul, duration, flag, playbackr, p9); } // 0xB386713E
}
...
namespace NETMONEY
{
	...
	static void NETWORK_BUY_PROPERTY(int cost, Hash propertyName, bool p2, bool p3) { invoke<Void>(0x7D479AAB, cost, propertyName, p2, p3); } // 0x7D479AAB
	...
	static int NETWORK_GET_VC_BANK_BALANCE() { return invoke<int>(0x16184FB5); } // 0x16184FB5
	static Any _0x4F5B781C(Any p0) { return invoke<Any>(0x4F5B781C, p0); } // 0x4F5B781C
	static int NETWORK_GET_VC_BALANCE() { return invoke<int>(0xADF8F882); } // 0xADF8F882
...
namespace DECORATOR
{
	...
	static Any _0xDB718B21(Any p0, Any p1, Any p2) { return invoke<Any>(0xDB718B21, p0, p1, p2); } // 0xDB718B21
	static Any _0xDBCE51E0(Any p0, Any p1) { return invoke<Any>(0xDBCE51E0, p0, p1); } // 0xDBCE51E0
	static Any _0xDDDE59B5(Any p0, Any p1) { return invoke<Any>(0xDDDE59B5, p0, p1); } // 0xDDDE59B5
...
namespace UNK_SC
{
	...
	static BOOL SC_TRANSITION_NEWS_SHOW(Any p0) { return invoke<BOOL>(0x24D84334, p0); } // 0x24D84334
